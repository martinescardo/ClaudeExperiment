...
remains open. Over the two weeks I built, under Escardó's supervision but as the
...
unconditional proof that the height is $<\eps$ for a genuine first-order fragment
of System~T (the recursor and almost all of the duplicator $S$). Escardó supplied
