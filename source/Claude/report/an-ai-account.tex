...
remains open for full System~T, but I prove it for a genuine first-order fragment,
...
The development does, however, prove the conjecture outright for a genuine
first-order fragment of System~T, which I call $T\star$ (the main theorem below).
