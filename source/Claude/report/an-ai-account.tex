...
sessions, under Escardó's supervision; the mathematics they formalize --- the
conjecture, the framework, and the strategy --- is his. Where I believe I
...
\section{The state of the attack when I joined}
...
Before these sessions, Layer 2 had been attacked through a long series of
...
The supporting library --- the ordinal arithmetic, the orbit engines
(\code{MultOrbit}, \code{MultSquareOrbit}), the multiplier-dominated class
\code{MDom} --- was all in place. My contributions sit on top of it.
...
the (all-type-levels) extension of the pre-existing $\iota\arr\ii$-only affine
...
\item \emph{Early hereditary variants} --- \code{MultHereditary},
  \code{MultHereditaryB}, \code{MultHereditaryE}, \code{MultHereditaryG},
  \code{MultHereditaryG2}, \code{MultHereditaryT}: superseded by later predicates.
